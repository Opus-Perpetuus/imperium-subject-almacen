...
export const pedidos_surtir_pages: KirletPageDecl[] = [
  {
    ...
    build: () =>
      build_feature_shell_page({
        ...
        title: "Por surtir",
        props: {
          basePath: "pedidos-surtir",
          idKey: "id",
          nameKey: "name",
          view: {
            title: "Por surtir",
            subtitle: "Submenú de almacen",
            pluralLabel: "por surtir",
            singularLabel: "por surtir",
            emptyTitle: "Sin registros",
            emptyDescription: "Migra desde Mongo o crea el primero",
          },
          data: {
            list: `${API}/pedidos-surtir`,
            record: `${API}/pedidos-surtir/:id`,
            create: { method: "POST", action: `${API}/pedidos-surtir` },
            update: { method: "PATCH", action: `${API}/pedidos-surtir/:id` },
            delete: { method: "DELETE", action: `${API}/pedidos-surtir/:id` },
          },
          table: {
            columns: [
