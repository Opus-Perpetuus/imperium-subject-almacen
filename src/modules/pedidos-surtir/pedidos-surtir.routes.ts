...
import { pedidos_surtir_pages } from "./pedidos-surtir.pages.ts";
import { pedidos_surtir_tables } from "./pedidos-surtir.tables.ts";

export const pedidos_surtir_module = define_module({
  resource: "pedidos-surtir",
  labels: {
    singular: "Por surtir",
    plural: "Por surtir",
    read: "Ver Por surtir",
    write: "Editar Por surtir",
  },
  routes: define_crud({
    resource: "pedidos-surtir",
    table: "pedidos_surtir",
    soft_delete: true,
  ...
  tables: pedidos_surtir_tables,
  pages: pedidos_surtir_pages,
  menu: [],
});
