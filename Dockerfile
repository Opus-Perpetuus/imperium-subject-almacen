...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-almacen"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-almacen"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-almacen \
    KIRLET_TECHNICAL_ID=subject-almacen \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
